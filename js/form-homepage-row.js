...
<div style="text-align:-webkit-center;border:1.5px solid #000;width:98%;padding:10px 20px;max-width:500px;" > 
<a href="" class="scroll box" style="border-color:#000;text-align:-webkit-center;">
    ...
    <h1 class="form-top-title">이번 혜택이 끝나면 유료로 전환됩니다.<br></h1>
          ...
          <!-- <input type="hidden" name="entry.272078534" value="onepage"> -->
            ...
            <br>
                <table class="form-box-tb">
                    <tbody>
                    <tr id="select_lic">
                    <th><!--<i class="fa fa-user" aria-hidden="true"></i>-->직책<br></th>
                    <td>

                        <select name='entry.1586659421' id='mf' class="form-control" placeholder="성별">

                            <option value="직책" selected disabled>직책 선택</option>
                                <option value="대표변호사">대표변호사</option>
                                <option value="파트너변호사">파트너변호사</option>
                    ...
                    <tr>
                        <th><!--<i class="fa fa-user" aria-hidden="true"></i>-->이메일</th>
                        <td>
                            <input type='text' name='entry.750489281' id='email' class="form-control" placeholder="이메일 주소" >
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2" style="border-bottom: none"> 
                            ...
                            <input class="submit-btn" type='submit' id='send_message' value='무료 혜택 받기' disabled >
          ...
          <div class="box_02_1">
              <div style="position:relative;height:150px;overflow:hidden;">
                  <div id="ticker_wrap" style="position: absolute;top:0px;right:0px;width:100%;">
                      ...
                      <tbody>
                          <tr>
                              <td class="tg-0lax"><span class="submit_02">무료 혜택 신청</span></td>
                              <td class="tg-02ax">대표 변호사</td>
                          ...
                          <tr>
                              <td class="tg-0lax"><span class="submit_02">무료 혜택 신청</span></td>
                              <td class="tg-02ax">사무장</td>
                              <td class="tg-03ax"><span class="submit_03">신청완료</span></td>
                          </tr>
                          <tr>
                              <td class="tg-0lax"><span class="submit_02">무료 혜택 신청</span></td>
                              <td class="tg-02ax">파트너 변호사</td>
                              <td class="tg-03ax"><span class="submit_03">신청완료</span></td>
                          </tr>
                          <tr>
                              <td class="tg-0lax"><span class="submit_02">무료 혜택 신청</span></td>
...
<div id="privacy">
    <div id="privacyContent">
      ...
      <div style="line-height:1.2" class="conWrap">
        개인정보처리방침<br><br>
        ‘변호사마케팅방정식’ 회사는 (이하 ‘회사’는) 고객님의 개인정보를 중요시하며, “개인정보보호법”, “정보통신망 이용촉진 및 정보보호에 관한 법률”등 관련법규를 준수하고 있습니다. 회사는 개인정보취급방침을 통하여 고객님께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.<br />
